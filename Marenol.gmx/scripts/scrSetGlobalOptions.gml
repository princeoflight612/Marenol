...
global.roomCaptionDef = "I Wanna Marenol";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rPPreAvoidance;    //sets which room to begin with
